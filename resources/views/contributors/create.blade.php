...
<div class="page-header">
  ...
  <h1 class="ph-title">Add Contributor or Guest</h1>
</div>
...
<div class="form-wrapper">
  <form method="POST" action="{{ route('contributors.store') }}">
    ...
    <div class="form-card">
      ...
      <div class="fc-sub">Enter the contact information for this individual.</div>
      
      <div class="form-grid">
        <div class="form-group fg-full">
          <label>Full Name</label>
          <input type="text" name="full_name" class="form-input" placeholder="e.g. John Doe" value="{{ old('full_name') }}" required>
          @error('full_name')<span class="error-msg">{{ $message }}</span>@enderror
        </div>

        <div class="form-group">
          <label>Phone Number</label>
          <input type="text" name="phone" class="form-input" placeholder="e.g. +255 700 000 000" value="{{ old('phone') }}" required>
    ...
    <div class="form-actions">
      ...
      <button type="submit" class="btn-submit">Add Contributor</button>
    </div>
  </form>
</div>
